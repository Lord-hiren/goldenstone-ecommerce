  ...
  return (
    <Container maxWidth="md" sx={{ mt: 4, mb: 4 }}>
      ...
      <Typography paragraph>
        ...
        craftsmanship. Our mission is to offer high-quality pieces that reflect
        individuality and style, without the use of gold, silver, or real
        diamonds.
      </Typography>
      ...
      <Typography paragraph>
        Our vision is to empower our customers by providing them with beautiful,
        affordable jewelry that enhances their style. We take pride in our
        commitment to quality, customer satisfaction, and ethical practices in
